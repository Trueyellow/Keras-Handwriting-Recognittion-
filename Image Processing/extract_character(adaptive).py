...
for i in range(len(contour_list)):
    ...
    if x-15>0 and x+h+2<gray1.shape[0] and y-3>0 and y+w+3<gray1.shape[1]:
        test = gray1[x - 80:x + h + 2, y - 3:y + w + 3]
    elif x-15<0 and x+h+2<gray1.shape[0] and y-3>0 and y+w+3<gray1.shape[1]:
        test=gray1[0:x+h,y:y+w]
    else:
        test=gray[x:x+h,y:y+w]
